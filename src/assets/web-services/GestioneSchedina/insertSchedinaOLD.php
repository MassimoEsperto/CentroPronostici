...
if(isset($postdata) && !empty($postdata))
{
  ...
  $dati= $request->data;
	...
	foreach($dati as $item) 
	{
		  ...
		  // Sanitize.
		  $id_calendario = mysqli_real_escape_string($con, (int)$item->id_calendario);
		  ...
		  // Store.
		  $sql .= "INSERT INTO `schedina`(`id_calendario`, `id_schedina`, `risultato`, `tipo`) VALUES ('{$id_calendario}','{$id_schedina}','{$risultato}','{$tipo}');";
