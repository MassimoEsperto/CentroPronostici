...
$ele = 0;
$list = [];
$sql1 ="SELECT r.id_evento,r.tipo,r.partita FROM _scommesse_risultati r order by r.id_evento";
...
$sql3 = "SELECT s.id_evento,s.tipo,p.descrizione,s.girone ";
$sql3 .="FROM _scommesse_antepost_gironi s,_punti_previsti p  ";
$sql3 .="WHERE s.punti_id=p.id_punti order by s.id_evento ";
